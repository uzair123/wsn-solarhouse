...
/* other definitions */
#define SELFUR_FLOODING_QUEUE_TIME 50
...
//#define SELFUR_ROUTING_ENTRY_TTL 80
...
extern struct routing_entry * get_routing_list();

extern struct scope_entry * get_scopes_list();

// position of current node in tree
extern uint8_t get_node_tree_height();

// max received tree height
extern uint8_t get_max_tree_height();

extern uint8_t is_forwarder(uint8_t scope_id);
