...
static uint8_t scope_spec_upper[] = {17,
				OPERATOR_OR,
				PREDICATE_EQ, REPOSITORY_VALUE, NODE_ID, UINT8_VALUE, 2, //LEN 5
				OPERATOR_OR,
				PREDICATE_EQ, REPOSITORY_VALUE, NODE_ID, UINT8_VALUE, 3,
				PREDICATE_EQ, REPOSITORY_VALUE, NODE_ID, UINT8_VALUE, 4
			};
static uint8_t scope_spec_lower[] = {17,
				OPERATOR_OR,
				PREDICATE_EQ, REPOSITORY_VALUE, NODE_ID, UINT8_VALUE, 5, //LEN 5
				OPERATOR_OR,
				PREDICATE_EQ, REPOSITORY_VALUE, NODE_ID, UINT8_VALUE, 6,
				PREDICATE_EQ, REPOSITORY_VALUE, NODE_ID, UINT8_VALUE, 7
			};
static uint8_t scope_spec_outside[] = {17,
				OPERATOR_OR,
				PREDICATE_EQ, REPOSITORY_VALUE, NODE_ID, UINT8_VALUE, 8, //LEN 5
				OPERATOR_OR,
				PREDICATE_EQ, REPOSITORY_VALUE, NODE_ID, UINT8_VALUE, 9,
				PREDICATE_EQ, REPOSITORY_VALUE, NODE_ID, UINT8_VALUE, 10
			};
